...
const cozycook: Project = {
  ...
  link: { label: "GitHub", href: "https://github.com/julmichael95/Cozycook" },

  hero: {
    src: "/images/cozycook/hero.png",
    alt: "CozyCook home screen showing featured picks and quick & easy recipes",
  ...
  screens: [
    {
      src: "/images/cozycook/screen-1.png",
      alt: "Pantry Search screen — type ingredients you have and find matching recipes",
      placeholder: "CozyCook — pantry search",
      caption: "The Pantry tab is the core input: type what you have and the app surfaces matching recipes. Common staples are one tap to add. Your ingredients are the starting point — not an afterthought.",
      variant: "mobile",
      objectPosition: "top",
    },
    {
      src: "/images/cozycook/screen-2.png",
      alt: "AI Recipe Generator with ingredient input, cooking time, difficulty, cuisine, and dietary filters",
      placeholder: "CozyCook — AI generator",
      caption: "The Generate tab takes your pantry ingredients and runs them through Claude — layered with cooking time, difficulty, cuisine, and dietary constraints — to produce recipes matched to what you actually have.",
      variant: "mobile",
      objectPosition: "top",
    },
    {
      src: "/images/cozycook/screen-3.png",
      alt: "Browse Recipes screen showing recipe grid filtered by cuisine and difficulty",
      placeholder: "CozyCook — browse recipes",
      caption: "Browse surfaces the full recipe catalog, filterable by cuisine and difficulty. Every recipe card shows cook time and a difficulty badge — enough to make a fast decision before committing.",
      variant: "mobile",
      objectPosition: "top",
    },
  ],
