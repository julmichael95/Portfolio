...
const ansa: Project = {
  ...
  workCard: {
    ...
    description:
      "An AI customer success platform for monitoring account health, surfacing churn risk, and giving CS teams a clear next action per account. The design problem: making AI useful for structured operational work — not just a chat layer on top of existing tools.",
    cta: "See workflow",
  },
};
